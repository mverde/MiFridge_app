...
/**
 * Created by Martin on 1/16/2016.
 */
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        boolean nameAuthenticated = false;
        Log.i(TAG, "Getting registration token");
        ...
        try {
            ...
            if ((nameAuthenticated = sendRegistrationToServer(intent.getStringExtra("name"), token))) {
